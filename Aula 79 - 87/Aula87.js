...
function reinicia()
{
    ...
    cancelAnimationFrame(frames) // Se não vai dobrar o frame rate, e ficar mais rápido cada vez que chamar
    vidaPlaneta=150
    pjx=tamTelaW/2 // Nave no centro
    pjy=tamTelaH/2
    jog.style.left=pjx+"px"
    jog.style.top=pjy+"px"
    contBombas=100
    jogo=true
    tmpCriaBomba=setInterval(criaBomba,1700) // Intervalo
    gameLoop()
}
function inicia()
{
